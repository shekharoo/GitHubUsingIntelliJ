...
public class NinzaAutomation_TestNG extends BaseClass {
...
//    }
    ...
    public static void ninzaTC09CreateContactUsingCampaignID() throws InterruptedException, IOException, ParseException {
        ...
        NinzaAutomation_TestNG.verifyPopUpAndCreation(driver,"contact");
        //Close popUp
        createCampPage.getClosePopUp().click();
        //Logout of App
        NinzaAutomation_TestNG.logoutNinZa(driver);
    ...
    public static void ninzaTC10CreateProduct() throws Throwable {
       ...
       //Verify product pop up and product creation
        NinzaAutomation_TestNG.verifyPopUpAndCreation(driver,"product");
        //Thread.sleep(5000);
        //Close popUp
        createCampPage.getClosePopUp().click();
        //Logout of App
...
//        NinzaAutomation_TestNG na= new NinzaAutomation_TestNG();
...
//        NinzaAutomation_TestNG.ninzaTC10CreateProduct();
