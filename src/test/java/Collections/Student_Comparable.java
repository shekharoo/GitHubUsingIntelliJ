...
public class Student_Comparable extends College_Comperable implements Comparable<Student_Comparable>{
   ...
   Student_Comparable()
   {
    ...
    Student_Comparable(String name, int age, String address)
    {
        super();
        this.name=name;
        this.age=age;
